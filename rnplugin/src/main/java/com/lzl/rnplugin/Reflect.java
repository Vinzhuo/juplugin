...
public class Reflect {
     ...
     * @see #on(Class)
     */
    public static Reflect on(String name) throws Exception {
     ...
     * @throws Exception
     */
    public Reflect set(String name, Object value) throws Exception {
        try {
     ...
     * @throws Exception
     */
    public Reflect field(String name) throws Exception {
        try {
            Field field = field0(name);
     ...
     * @return 包含所有字段的map
     */
    public Map<String, Reflect> fields() throws Exception {
     ...
     */
    public Reflect call(String name) throws Exception {
     ...
     * @throws Exception
     */
    public Reflect call(String name, Object... args) throws Exception {
     ...
     * @see #create(Object...)
     */
    public Reflect create() throws Exception {
     ...
     * @throws Exception
     */
    public Reflect create(Object... args) throws Exception {
        Class<?>[] types = types(args);
    ...
    private static Reflect on(Constructor<?> constructor, Object... args) throws Exception {
        try {
    ...
    private static Reflect on(Method method, Object object, Object... args) throws Exception {
        try {
            accessible(method);
